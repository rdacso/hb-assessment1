...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    cat_lists = foods1 + foods2
    duplicate_list = set([])
    for word in cat_lists:
        if cat_lists.count(word) > 1:
            duplicate_list.add(word)
        new_duplicate_list = list(duplicate_list)
